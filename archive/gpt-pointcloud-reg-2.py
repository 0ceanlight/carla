...
def main():
    ...
    source_file = "output_v1.log/sensor_captures_v3_cropped/ego_lidar/frames/10969.ply"
    target_file = "output_v1.log/sensor_captures_v3_cropped/infrastruct_lidar/frames/10969.ply"
