...
from utils.registration import register_and_view_multiple_point_clouds
...
register_and_view_multiple_point_clouds([(ego_file, ego_pose, ego_color), (infra_file, infra_pose, infra_color)])
